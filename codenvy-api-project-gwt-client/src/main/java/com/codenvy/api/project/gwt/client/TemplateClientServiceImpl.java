...
public class TemplateClientServiceImpl implements TemplateClientService {
    ...
    @Inject
    protected TemplateClientServiceImpl(@Named("restContext") String restContext, @Named("workspaceId") String workspaceId,
                                        Loader loader) {
    ...
    public void getTemplates(ProjectTypeDescriptor projectTypeDescriptor, AsyncRequestCallback<String> callback) throws RequestException {
        ...
        AsyncRequest.build(GET, requestUrl + param).header(HTTPHeader.ACCEPT, MimeType.APPLICATION_JSON).loader(loader)
                    .send(callback);
    }
