...
public class MessageBuilder {
    ...
    /**
     * Perform sanitizing message content inside {@link SafeHtml} to avoid XSS vulnerabilities. Enabled by default.
     *
     * @param sanitizing
     *         toggle sanitizing message content
     * @return an instance of {@link MessageBuilder}
     */
    @Nonnull
    public MessageBuilder sanitizing(boolean sanitizing) {
    ...
    public SafeHtml build() {
        ...
        String subMessage = message.substring(prefixes.length());
        builder.appendHtmlConstant(sanitizing ? SimpleHtmlSanitizer.sanitizeHtml(subMessage).asString() : subMessage);
